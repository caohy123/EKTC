...
def create_app(chat_model: "ChatModel") -> "FastAPI":
    ...
    async def create_chat_completion(request: ChatCompletionRequest):
        ...
        #     raise HTTPException(status_code=status.HTTP_400_BAD_REQUEST, detail="Only supprots u/a/u/a/u...")
...
if __name__ == "__main__":
    ...
    uvicorn.run(
        app, host = "0.0.0.0", port=int(os.environ.get("API_PORT", 9099)), workers = 1
    )